globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-CiDrEpl_.js","assets/layout-segment-context-CGENnlpk.js"];
...
function getDraftSecret() {
	return "2474a469-3f86-4489-8f0d-a6e4b537419f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "c0b305ff-a3dc-4ca7-93cf-abf1de3e777a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "c0b305ff-a3dc-4ca7-93cf-abf1de3e777a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "c0b305ff-a3dc-4ca7-93cf-abf1de3e777a",
		rootBoundaryId
	});
}
/**
...
async function generateMetadata() {
	...
	const imageUrl = `${headerList.get("x-forwarded-proto") ?? (host.startsWith("localhost") ? "http" : "https")}://${host}/og.png`;
	return {
